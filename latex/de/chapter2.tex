...
Woher weiß ich, wie weit ich von zu Hause entfernt bin? Wenn ich auf einer $5$ bin, bin ich dann auf der ersten $5$ - der direkt neben dem Haus - bin ich dann auf der zweiten? Der dritten? Wie soll ich mich orientieren, fragt sich Ada.
...
Die Farben sind vielleicht nicht die richtige Lösung, aber all das bringt sie auf eine andere Idee. Ada notiert, wie oft sie alle Zahlen verwendet. Sie beginnt von zu Hause aus: $0$, $1$, $2$, $3$, $4$, $5$, $6$, $7$, $8$ und $9$. Nach $9$ beginnt Ada die Zahlenreihe erneut. Sie notiert $0$. Und damit sie nicht vergisst, dass sie gerade die ganze Zahlenreihe zum ersten Mal benutzt hat, notiert sie links von sich eine $1$. Ada erhält $1~0$ (\qq{eins-null}). Und sie fährt fort, nachdem sie $1~1$ (\qq{eins-eins}), $1~2$ (\qq{eins-zwei}), $1~3$ (\qq{eins-drei}), $1~4$, $1~5$, $1~6$, $1~7$, $1~8$ und $1~9$ notiert hat. 
